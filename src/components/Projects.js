                    ...
                    <center>
                        ...
                        <div className="row justify-content-center">
                            <div className="col-md-3">
                                ...
                                <p><h><b>Technologies : </b></h>HTML, CSS, Bootstrap, JS, Nodejs and MySql</p>
                            ...
                            <div className="col-md-3">
                                ...
                                <p><h><b>Technologies : </b></h>HTML, CSS, Bootstrap, Nodejs and MongoDB</p>
                                <a href="#">Source Code</a>
                            </div>
                            <div className="col-md-3">
                                <h3>Chess</h3>
                                ...
                                <p><h><b>Technologies : </b></h>Express, Socket.io</p>
                            ...
                            <div className="col-md-3">
                                ...
                                <p><h><b>Technologies : </b></h>HTML, CSS, Bootstrap, JS, C# and MySql</p>
                                <a href="#" target="_blank">Source Code</a>
                            </div>
                            <div className="col-md-3">
                                <h3>Pixbrainy</h3>
                                ...
                                <p><h><b>Technologies : </b></h>React JS, Bootstrap, JS, Express and MySql</p>
                                <a href="#" target="_blank">Source Code</a>
                            </div>
                            <div className="col-md-3">
                                <h3>BrilBrands</h3>
                                ...
                                <p><h><b>Technologies : </b></h>HTML, CSS, Epxress and MongoDB</p>
                                <a href="#" target="_blank">Source Code</a>
                            </div>
                            <div className="col-md-3">
                                <h3>Blog Website</h3>
                                ...
                                <p><h><b>Technologies : </b></h>HTML, CSS, Bootstrap, JS, Express/Nodejs</p>
                                <a href="" target="_blank">Source Code</a>
                            </div>
                            <div className="col-md-3">
                                <h3>Data Structures</h3>
                                <hr />
                                <p>Famous data structures coded in Js. For example Stack, Queue, Linked List, Polynomial, Stack Template</p>
                                <p><br /><h><b>Technologies : </b></h>JS</p>
